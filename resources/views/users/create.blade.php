                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('area') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('area') ? ' is-invalid' : '' }}" name="area" id="input-area" type="text" placeholder="{{ __('Area/Zona') }}" value="{{ old('area') }}" required="true" aria-required="true"/>
                      @if ($errors->has('area'))
                        <span id="name-error" class="error text-danger" for="input-area">{{ $errors->first('area') }}</span>
                      @endif
                    </div>
                  </div>
                </div>
